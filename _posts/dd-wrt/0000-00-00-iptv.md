...
1. Enable ssh:
* ![](/assets/img/dd-wrt/enable-ssh.jpg){: .center-image }

2. Enable jffs:
* ![](/assets/img/dd-wrt/enable-jffs.jpg){: .center-image }

3. Connect to ssh:
* ![](/assets/img/dd-wrt/connect-to-ssh.png){: .center-image }
...
6. Add command:
* ![](/assets/img/dd-wrt/add-command.png){: .center-image }
